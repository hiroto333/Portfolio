...
export default function ProductDetailPage() {
  ...
  const productDetails = {
    ...
    "5": {
      ...
      longDescription:
        "非常持ち出し袋の中身は、物を詰め込み過ぎると重量が増し、緊急時に持ち運ぶことが困難になるため、限られた重さの中で個人に合った適切な物を選ぶ必要があります。しかし、Webサイトやチェックリストで紹介されている物品の種類は膨大で、自分に本当に必要な物を判断するのは難しいのが現状です。さらに、被災状況を具体的にイメージすることが重要とされる一方で、見落としも起こりやすいという課題があります。そこで本研究では、ユーザーが作成した非常持ち出し袋では対応できない状況をシステムが提示することで、未考慮の状況に気づきを与える支援システムを提案しました。この提案手法と、Web検索のみで情報収集を行う従来手法を比較する実験を実施したところ、提案手法は全ての被験者に対して新たな状況への気づきを促し、より個人に適した非常持ち出し袋の検討に貢献することが明らかになりました。また、災害への想像力や対応力の一部項目にも改善が見られました。",
